...
class UserAuthentificatorAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        $user = $this->entityManager->getRepository(Compte::class)->findOneBy(['adresseMail' => $credentials['adresseMail']]);

        if (!$user) {
            throw new UsernameNotFoundException('Adresse mail could not be found.');
        }
